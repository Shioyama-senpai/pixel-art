	...
	<?php
		...
		foreach ($allPosts as $post) {
			...
			if ($post["license"] == "cc-by") {
				$licenseText = "<a href=\"http://creativecommons.org/licenses/by/4.0/\" target=\"_blank\">CC BY</a>";
			}
			if ($post["license"] == "cc-by-sa") {
				$licenseText = "<a href=\"http://creativecommons.org/licenses/by-sa/4.0/\" target=\"_blank\">CC BY-SA</a>";
			}
			if ($post["license"] == "cc-by-nc") {
				$licenseText = "<a href=\"http://creativecommons.org/licenses/by-nc/4.0/\" target=\"_blank\">CC BY-NC</a>";
			}
			if ($post["license"] == "cc-by-nc-sa") {
				$licenseText = "<a href=\"http://creativecommons.org/licenses/by-nc-sa/4.0/\" target=\"_blank\">CC BY-NC-SA</a>";
			}
			if ($post["license"] == "cc-by-nd") {
				$licenseText = "<a href=\"http://creativecommons.org/licenses/by-nd/4.0/\" target=\"_blank\">CC BY-ND</a>";
			}
			if ($post["license"] == "cc-by-nc-nd") {
				$licenseText = "<a href=\"http://creativecommons.org/licenses/by-nc-nd/4.0/\" target=\"_blank\">CC BY-NC-ND</a>";
			}
